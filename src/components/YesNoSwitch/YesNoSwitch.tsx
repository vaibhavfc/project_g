...
const YesNoSwitch: FC<YesNoSwitchProps> = ({
  ...
  const [select1, setSelect1] = useState(defaultValue);
  const [select2, setSelect2] = useState(!defaultValue);
